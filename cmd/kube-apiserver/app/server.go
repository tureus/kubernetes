...
func (s *APIServer) Run(_ []string) error {
	...
	authenticator, err := apiserver.NewAuthenticator(s.BasicAuthFile, s.ClientCAFile, s.TokenAuthFile, s.OpenIDClientID, s.OpenIDEndpoint, s.ServiceAccountKeyFile, s.ServiceAccountLookup, helper)
	if err != nil {
